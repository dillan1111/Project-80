  ...
  renderItem = ( {item, i} ) =>(
    <ListItem bottomDivider> 
      <ListItem.Content> 
        ...
        <Text>0-3 yrs</Text>
        <ListItem.Subtitle> {item.zero_three} </ListItem.Subtitle> 
        <Text>4-6 yrs</Text>
        <ListItem.Subtitle> {item.four_six} </ListItem.Subtitle> 
        <Text>7-10 yrs</Text>
        <ListItem.Subtitle> {item.seven_ten} </ListItem.Subtitle> 
      </ListItem.Content> 
